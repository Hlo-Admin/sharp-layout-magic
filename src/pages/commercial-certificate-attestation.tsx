...
import attestationData from "@/data/commercialCertificateAttestation";

const CommercialCertificateAttestation = () => {
  const currentUrl = typeof window !== "undefined" ? window.location.href : "";
  const baseUrl = typeof window !== "undefined" ? window.location.origin : "";
  const imageUrl = `${baseUrl}${attestationData.heroData.image}`;

  const keywords = [
    "commercial certificate attestation Dubai",
    "business document attestation UAE",
    "MOFA commercial attestation",
    "trade license attestation Dubai",
    "GoKite PRO business services",
  ].join(", ");
  ...
  return (
    <>
      <Helmet>
        <title>
          Commercial Certificate Attestation Dubai | Business Docs UAE
        </title>
        <meta
          name="description"
          content="Get commercial & business certificates attested in Dubai. Fast, reliable, and MOFA-approved attestation services for all your corporate documents in UAE."
        />
        ...
        <meta
          property="og:title"
          content="Commercial/Business Certificate Attestation Services in Dubai, UAE"
        />
        <meta
          property="og:description"
          content="Legal attestation services for business documents like trade licenses, resolutions, and agreements for UAE use."
        />
...
export default CommercialCertificateAttestation;
