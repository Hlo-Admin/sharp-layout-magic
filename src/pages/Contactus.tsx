          ...
          <div className="grid md:grid-cols-3 gap-10">
                  ...
                  {contactData.hero.fields.map((field, i) => (
                    <div key={i}>
                      ...
                      <input
                        ...
                        className="w-full border-b border-gray-300 focus:border-gray-800 focus:outline-none py-2 text-gray-700"
                      />
                    </div>
                  ))}
                </div>
            ...
            <div className="flex md:flex-col justify-start items-center md:items-end mt-10 md:mt-0 space-x-6 md:space-x-0 md:space-y-6">
              {contactData.hero.socials.map((social, index) => (
                <div
                  key={index}
                  className="w-10 h-10 flex items-center justify-center border border-gray-300 rounded-full hover:bg-gray-100 transition cursor-pointer"
                >
                  <span className="text-gray-600 capitalize">{social[0]}</span>
                </div>
              ))}
            </div>
          </div>
