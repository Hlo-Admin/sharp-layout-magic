    ...
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/business-setup/mainland-company-formation-in-dubai" element={<Mainland />} />
          <Route path="/business-setup/freezone-company-formation-in-dubai/" element={<Freezone />} />
          <Route path="/business-setup/offshore-company-formation-in-dubai/" element={<Offshore />} />
          <Route path="/business-setup/sme-company-formation-in-dubai/" element={<Smecompany />} />
          <Route path="/business-setup/tarakhees-company-formation-in-dubai/" element={<Tarakhees />} />
          <Route
          ...
          <Route path="/pro-services/investor-visa/" element={<InvestorVisa />} />
          <Route path="/pro-services/golden-visa/" element={<GoldenVisa />} />
          <Route path="/pro-services/family-visa/" element={<FamilyVisa />} />
          <Route path="/pro-services/employment-visa/" element={<EmploymentVisa />} />
          <Route path="/brand-registration/brand-name-registration-services-in-dubai/" element={<BrandNameRegistration />} />
          <Route path="/brand-registration/domain-name-protection-services-in-dubai/" element={<DomainNameProtection />} />
          <Route path="/brand-registration/real-estate-name-registration-services-in-dubai/" element={<RealEstateNameRegistration />} />
          <Route path="/legal-support-services/rental-dispute-center-services-in-dubai/"  element={<RentalDisputeCenter />} /> 
          <Route path="/legal-support-services/labour-case-filing-documentation-services-in-dubai"  element={<LabourCaseFiling />} /> 
          <Route path="/legal-support-services/court-applications-services-in-dubai/" element={<CourtApplications />} />
          <Route path="/legal-support-services/heirship-certificate-applications-services-in-dubai/" element={<HeirshipCertificate />} />
          <Route path="/legal-support-services/cheque-execution-filing-services-in-dubai/" element={<ChequeExecution />} /> 
          <Route path="/legal-support-services/case-clearance-services-in-dubai/" element={<CaseClearance />} /> 
          <Route path="/legal-support-services/court-memo-drafting-services-in-dubai/"  element={<CourtMemoDrafting />} /> 
          <Route path="/tax-registration/vat-registration/" element={<VATRegistration />} /> 
          <Route path="/tax-registration/corporate-tax-consultation-filing/"  element={<CorporateTax />} /> 
          <Route path="/tax-registration/fta-works-services-in-dubai/" element={<FTAWorks />} />
          <Route path="/translation-services/legal-translation-services-in-dubai/" element={<LegalTranslation />} />
          <Route path="/translation-services/official-translation-services-in-dubai/" element={<OfficialTranslation />} />
          <Route path="/translation-services/normal-translation-services-in-dubai/" element={<NormalTranslation />} />
          <Route path="/typing-services/letter-drafting-services-in-dubai/" element={<LetterDrafting />} />
          <Route path="/typing-services/memorandum-of-association/" element={<MemorandumOfAssociation />} />
          <Route path="/typing-services/court-memo-typing-services-in-dubai/" element={<CourtMemoTyping />} />
          <Route path="/typing-services/power-of-attorney/" element={<PowerOfAttorney />} />
          <Route path="/attestation-services/personal-certificate-attestation/" element={<PersonalCertificateAttestation />} /> 
          <Route path="/attestation-services/educational-certificate-attestation/" element={<EducationalCertificateAttestation />} />
          <Route path="/attestation-services/commercial-certificate-attestation/" element={<CommercialCertificateAttestation />} />
          <Route path="/birth-certificate-attestation-services-in-dubai/" element={<BirthCertificateAttestation />} />
          <Route path="/marriage-certificate-attestation-services-in-dubai/" element={<MarriageCertificateAttestation />} />
          <Route path="/death-certificate-attestation-services-in-dubai/" element={<DeathCertificateAttestation />} />
          <Route path="/degree-certificate-attestation-services-in-dubai/" element={<DegreeCertificateAttestation />} />
          <Route path="/diploma-certificate-attestation-services-in-dubai/" element={<DiplomaCertificateAttestation />} />
          <Route path="/school-certificate-attestation-services-in-dubai/" element={<SchoolCertificateAttestation />} />
          <Route path="/articles-of-association-attestation-services-in-dubai/" element={<ArticlesOfAssociationAttestation />} />
          <Route path="/invoices-and-agreements-attestation-services-in-dubai/" element={<InvoicesAgreementsAttestation />} />
          <Route path="/true-copy-attestation-services-in-dubai/" element={<TrueCopyAttestation />} />
          <Route path="/document-verification-services-in-dubai/" element={<DocumentVerification />} />
          <Route path="/mofa-services-dubai/" element={<MOFAServices />} />
          <Route path="/moj-attestation-services-in-dubai/" element={<MOJAttestation />} />
          <Route path="/signature-verification-and-attestation-services-in-dubai/" element={<SignatureVerification />} />
          <Route path="/lawyer-attestation-services-in-dubai/" element={<LawyerAttestation />} />
          <Route path="/attestation-services" element={<AttestationServices />} />  
          <Route path="/trade-name-registration-services-in-dubai/" element={<TradeNameRegistration />} />
          <Route path="/logo-registration-services-in-dubai" element={<LogoRegistration />} />
          <Route path="/legal-support-services" element={<LegalSupportServices />} />
          <Route path="LegalSupportServices/case-registration-services" element={<CaseRegistrationServices />} />
          <Route path="/complaint-filing" element={<ComplaintFiling />} />
          <Route path="/tax-registration" element={<TaxRegistration />} />
          <Route path="/insurance-services-dubai" element={<InsuranceServices />} />
