...
export const freeZonesData = {
  title: "Popular Free Zones in the UAE",
  zones: [
    {
    ...
    },
    {
      ...
      links: ["Ajman Free Zone (AFZ)"],
      button: "Setup In Ajman",
    },
    {
      title: "Fujairah Free Zone",
      links: ["Fujairah Creative City"],
      button: "Setup In Fujairah",
    },
  ],
};
