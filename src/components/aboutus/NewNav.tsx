...
const NewNav = () => {
  ...
  return (
    <>
      <nav className="relative left-0 right-0 bg-[#487b99] flex items-center justify-between h-[56px] sm:h-[60px] md:h-[64px] px-3 sm:px-5 md:px-7 rounded-2xl shadow-xl z-[100] mx-2 sm:mx-3 md:mx-5">
        {/* Left Logo */}
      ...
      {isMobileMenuOpen && (
        <div className="relative top-2 left-0 right-0 bg-[#487b99] backdrop-blur-md rounded-lg shadow-2xl z-[200] lg:hidden overflow-hidden border border-white/10 mx-2 sm:mx-3 md:mx-5">
