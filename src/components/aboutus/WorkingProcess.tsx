      ...
      <div className="container mx-auto px-6 max-w-8xl">
            ...
            >
              <div className="text-4xl">
                {item.icon.startsWith("/") ? (
                  <img src={item.icon} alt={item.title + " icon"} className="inline-block w-24 h-24 object-contain" />
                ) : (
                  item.icon
                )}
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-12 border border-gray-300 flex items-center justify-between">
          <div className="max-w-[70%] space-y-4">
            <h3 className="text-lg font-semibold text-black">Performance Efficiency</h3>
            <ul className="space-y-2 text-lg text-black list-disc list-inside">
              <li>
                <strong>Optimized Operations</strong> – Fast bookings, instant confirmations, and minimal wait times
              </li>
              <li>
                <strong>Smart Resource Use</strong> – Leveraging technology to deliver maximum value with fewer hassles.
              </li>
              <li>
                <strong>Consistent Reliability</strong> – High uptime, smooth experiences, and zero compromise on speed.
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col items-start space-y-4">
            <div className="text-4xl">
              <img src="/aboutus/mission.png" alt="Mission Icon" className="inline-block w-24 h-24 object-contain" />
            </div>
            <div>
              ...
              <p className="text-lg text-black">
                At GoKite Pro, our mission is to simplify business on a global scale. We provide holistic, professional, and
                end-to-end services that span Mainland, Free Zone, and Offshore company formation, trade licenses, office solutions,
                visa and immigration assistance, document attestation, legal translation, trademark registration, banking advisory,
                accounting, and bookkeeping. By combining decades of industry experience with modern technology and a client-first
                approach, we reduce complexity, enhance efficiency, and ensure compliance — wherever our clients choose to grow.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-start space-y-4 pb-10">
            <div className="text-4xl">
                <img src="/aboutus/vision.png" alt="Vision Icon" className="inline-block w-24 h-24 object-contain" />
            </div>
            <div>
              ...
              <p className="text-lg text-black">
                Our vision is to become the world’s most trusted partner for business setup and growth — a one-stop global hub
                that transforms complex processes into simple, actionable solutions. We aspire to empower entrepreneurs, startups,
                and enterprises across borders by helping them focus on their goals, while we handle the rest — from compliance
                and licensing to visas, finance, and operational support.
              </p>
            </div>
          </div>
        </div>
