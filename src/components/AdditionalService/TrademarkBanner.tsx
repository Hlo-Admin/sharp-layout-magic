...
const TrademarkBanner: React.FC<TrademarkBannerProps> = ({ data }) => {
  return (
    <section className="relative w-full min-h-[200px] sm:min-h-[220px] flex items-center justify-center py-6 sm:py-10 lg:py-16 pr-3 sm:pr-6 lg:pr-10 pl-8 sm:pl-10 lg:pl-16 mb-8 sm:mb-12 mx-auto">
      {/* Background */}
      <img
