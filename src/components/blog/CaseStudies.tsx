...
import image from "/blog/work.png"
  ...
  const caseStudies = [
    {
      id: 1,
      image: "/blog/work.png",
      title: "How Branding Help your Business Grow 10X",
      description:
    ...
    },
    {
      id: 2,
      image: "/blog/work.png",
      title: "Building Digital Trust Through Design",
      description:
        "Discover how strategic UI/UX design built user trust and improved engagement by 80% in under 3 months.",
      author: "Daniel Cross",
      initials: "DC",
      date: "15 June",
    },
    {
      id: 3,
      image: "/blog/work.png",
      title: "How Rebranding Increased Sales by 60%",
      description:
        "See how a full brand identity overhaul turned a local store into a global e-commerce leader.",
      author: "Sophia Patel",
      initials: "SP",
      date: "21 July",
    },
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        {caseStudies.map((item) => (
          <article
            key={item.id}
            className="snap-start flex-shrink-0 w-full bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col lg:flex-row"
          ...
          >
            ...
            <div className="flex-1 p-6 lg:p-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-text-heading">{item.author}</span>
                ...
                <div className="text-text-body font-medium text-sm">{item.date}</div>
              </div>
            </div>
          </article>
        ))}
